...
class UNet_plus_plus_wo_dense(nn.Module):
    def __init__(self, num_classes, input_channels, block, num_blocks, nb_filter,deep_supervision=True):
        ...
        self.conv1_2 = self._make_layer(block, nb_filter[1] + nb_filter[2], nb_filter[1], num_blocks[0])
...
if __name__ == '__main__':
    ...
    model = UNet_plus_plus_wo_dense(num_classes=1, input_channels=in_channels, block=Res_block, num_blocks=num_blocks, nb_filter=nb_filter)
